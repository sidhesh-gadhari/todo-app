  ...
  return (
    <div style={{ padding: '40px', maxWidth: '800px', margin: '0 auto', color: '#f1f5f9', backgroundColor: '#06050a', fontFamily: "'Inter', sans-serif", minHeight: '100vh' }}>
      ...
      <p style={{ marginBottom: '15px', lineHeight: '1.6' }}>
        By accessing and using ToDo-App, you accept and agree to be bound by the terms and provision of this agreement.
      </p>

      <h2 style={{ color: '#e2e8f0', marginTop: '30px', marginBottom: '15px' }}>2. Description of Service</h2>
      <p style={{ marginBottom: '15px', lineHeight: '1.6' }}>
        ToDo-App provides users with a task management system. We integrate with Google Calendar to optionally set reminders for your tasks.
      </p>
